    ...
    <aside ref="sidebar" class="sidebar" :class="isMobileMenuOpen ? 'sidebar--open' : ''">
      ...
      <nav class="sidebar-nav">
        <ul class="sidebar-nav__list">
          ...
          <li>
            <router-link to="/postulante/mis-entrevistas" @click="closeMobileMenu" class="nav-link" active-class="nav-link--active">
              <span class="nav-link__icon">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <span class="nav-link__label">Mis Entrevistas</span>
            </router-link>
          </li>

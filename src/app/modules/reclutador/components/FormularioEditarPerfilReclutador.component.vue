...
const accionGuardar  = () => emit('guardar-cambios', { datosFormulario: { ...datosEditables.value } });
</script>
    ...
    <div class="frec-campos">
      ...
      <div class="campo">
        ...
        <div class="campo-wrap">
          ...
          <input id="frec_email" v-model="datosEditables.email" type="email"
                 class="campo-input" placeholder="empresa@correo.com" />
        </div>
      </div>
...
.frec-footer {
  ...
  gap: 0.75rem;
  padding-top: 1.5rem;
  border-top: 1px solid rgba(10,61,43,0.08);
}
@media (min-width: 480px) {
  .frec-footer { flex-direction: row; justify-content: flex-end; }
}
